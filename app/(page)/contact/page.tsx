      ...
      <section id="contact" className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Left - Contact Form */}
            <FadeUp delay={0.1}>
              <div className="bg-[#151B2E] rounded-2xl p-8 border border-white/10">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#0B1120] border border-white/10 rounded-xl text-white placeholder-gray-600 focus:border-blue-500 focus:outline-none transition-all"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-[#0B1120] border border-white/10 rounded-xl text-white focus:border-blue-500 focus:outline-none transition-all"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full px-4 py-3 bg-[#0B1120] border border-white/10 rounded-xl text-white placeholder-gray-600 focus:border-blue-500 focus:outline-none transition-all resize-none"
                  ...
                  <button
                    ...
                    className="w-full px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-all shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40"
                  >
                    Send Message →
                  </button>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-[#151B2E] rounded-2xl p-8 border border-white/10">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 mb-3">For immediate inquiries</p>
                      <a 
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3">
                        ...
                        <span className="text-gray-400 pt-1">{item.text}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              {/* Quick Stats */}
              <FadeUp delay={0.4}>
                <div className="bg-linear-to-br from-blue-600/10 to-purple-600/10 rounded-2xl p-8 border border-blue-500/20">
                  <h3 className="text-xl font-bold text-white mb-6">Platform Highlights</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-4 bg-[#0B1120]/50 rounded-xl">
                      <div className="text-2xl font-bold text-blue-400 mb-1">Patent</div>
          ...
          <FadeUp delay={0.5}>
            <div className="mt-20 text-center">
              <div className="inline-block bg-[#151B2E] rounded-2xl p-8 border border-white/10">
                <p className="text-gray-400 mb-4">Prefer a different contact method?</p>
                <a 
