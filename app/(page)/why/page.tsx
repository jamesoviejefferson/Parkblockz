          ...
          <FadeUp>
            <div className="max-w-5xl mx-auto mb-20">
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-12">
                ...
                <div className="bg-[#151B2E] rounded-2xl p-6 border-l-4 border-cyan-500">
                ...
                <div className="relative">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="shrink-0">
                      <div className="w-20 h-20 rounded-2xl bg-linear-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 flex items-center justify-center text-4xl mb-4 relative z-10">
                        {reason.icon}
                      </div>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-cyan-400">{reason.stat}</div>
                        <div className="text-xs text-gray-500 mt-1">{reason.statLabel}</div>
                      </div>
                    </div>

                    {/* Right Side - Content */}
                    <div className="flex-1 bg-[#151B2E] rounded-2xl p-8 border border-white/5 hover:border-cyan-500/30 transition-all">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20 max-w-6xl mx-auto">
              ...
              <div className="relative h-125 rounded-2xl overflow-hidden order-2 lg:order-1">
                ...
                <div className="absolute bottom-8 left-8">
                  <div className="text-2xl font-bold text-white">The Future is Now</div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h4 className="text-2xl font-bold text-red-400">Legacy Systems</h4>
                </div>
              ...
              <div className="bg-green-500/5 border border-green-500/20 rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-6">
                  <div className="text-3xl">✅</div>
                  <h4 className="text-2xl font-bold text-green-400">ParkBlockX™</h4>
                </div>
                <ul className="space-y-3">
                  {[
